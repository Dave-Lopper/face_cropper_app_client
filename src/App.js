...
import { AppTitle, ImageLabel, Paragraph } from "./styledComponents";
  ...
  return (
    <Row className="App">
      ...
      >
        ...
        <Paragraph style={{ marginBottom: 30 }}>
          We will detect faces on your image, crop it and let you download it !
        </Paragraph>
        {currentFile && (
          <>
        ...
        <form>
          ...
          <Form.Group>
            <Button
              ...
              onClick={uploadFile}
            >
              Crop <FaCropAlt style={{ color: "#DC143C", marginLeft: 10 }} />
            </Button>
          </Form.Group>
        </form>
        {srcImg !== "" && (
